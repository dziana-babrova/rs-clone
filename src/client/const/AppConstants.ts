...
export const SERVER_PROPS = {
  URL: 'https://rs-clone-server-production-739c.up.railway.app/api', //http://localhost:3000/api
  ONLINE: 'https://rs-clone-server-production-739c.up.railway.app/', //http://localhost:3000
};
